...
pub struct ExecveSandboxPredicate {
    ...
    pub attrs: ::std::collections::HashMap<String, (Box<dyn crate::rule::serializer::attribute::Attribute>, u8, u8)>,
}
...
impl ExecveSandboxPredicate {
    pub fn new() -> Self {
        ...
        for i in 0..MAX_ARGS_ATTRIBUTES {
            ...
            instance.attrs.insert(Attributes::Arg.name().to_string() + &i.to_string(), (attr, Attributes::Arg as u8, i as u8));
        }
...
impl crate::rule::serializer::PredicateSerializer for ExecveSandboxPredicate {
    ...
    fn serialize_attributes(
        ...
        let (attr, attr_idx, arg_num) = self.attrs
            .get_mut(name)
    ...
    fn store_attributes(
        ...
        for (attr, _, _) in self.attrs.values() {
