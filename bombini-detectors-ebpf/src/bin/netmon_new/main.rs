...
use bombini_detectors_ebpf::{
    ...
    filter::{
        netmon::ip_filter::{Ipv4Filter, Ipv6Filter},
        scope::ScopeFilter,
    },
...
pub fn tcp_v4_connect_new(ctx: FExitContext) -> i32 {
...
pub fn tcp_v6_connect_new(ctx: FExitContext) -> i32 {
...
pub fn tcp_close_v4_new(ctx: FExitContext) -> i32 {
...
#[fexit(function = "tcp_close")]
pub fn tcp_close_v6_new(ctx: FExitContext) -> i32 {
...
pub fn inet_csk_accept_new(ctx: FExitContext) -> i32 {
