...
use bombini_detectors_ebpf::filter::filemon::path_filter::PathFilter;
...
pub fn path_truncate_modified(ctx: LsmContext) -> i32 {
...
pub fn path_unlink_modified(ctx: LsmContext) -> i32 {
...
pub fn path_symlink_modified(ctx: LsmContext) -> i32 {
...
#[lsm(hook = "path_chmod")]
pub fn path_chmod_modified(ctx: LsmContext) -> i32 {
...
#[lsm(hook = "path_chown")]
pub fn path_chown_modified(ctx: LsmContext) -> i32 {
...
#[lsm(hook = "sb_mount")]
pub fn sb_mount_modified(ctx: LsmContext) -> i32 {
...
#[lsm(hook = "mmap_file")]
pub fn mmap_file_modified(ctx: LsmContext) -> i32 {
...
#[lsm(hook = "file_ioctl")]
pub fn file_ioctl_modified(ctx: LsmContext) -> i32 {
