...
impl dentry {
    ...
    rust_shim_kernel_trusted_or_null_impl!(pub, d_inode, dentry, d_inode, inode);
}
...
impl file {
    rust_shim_kernel_trusted_impl!(pub, f_inode, file, f_inode, inode);
    rust_shim_kernel_impl!(pub, file, f_path, path);
    rust_shim_kernel_trusted_impl!(pub, f_flags, file, f_flags, u32);
}
